...
async def check_all_columns():
    tables = [
        'published_papers', 'book_publications', 'ict_pedagogies', 
        'research_guidance', 'research_projects', 'ipr_entries', 
        'research_awards', 'conference_papers', 'research_proposals', 
        'product_developments', 'self_development_fdp', 'industrial_training'
    ]
